...
function SectionTwo() {
    return (
      ...
      <div className="grid md:h-gridd lg:h-tablet xl:h-desktop grid-rows-3 md:grid-cols-3 md:gap-4 lg:gap-8 md:px-12 px-10 lg:px-20 xl:pb-20">
            
      <div className="w-11/12 h-1/2 md:h-full lg:h-full xl:h-full">      
     ...
     <div className="md:w-11/12 w-full -mt-28 md:mt-0 h-full transition duration-500 ease-out transform hover:-translate-y-4">      
     ...
     <div className="md:w-11/12 w-full -mt-6 md:mt-0 h-full transition duration-500 ease-out transform hover:-translate-y-4">      
